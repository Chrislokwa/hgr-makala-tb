...
from .views import (
    CohorteView, DashboardView,
    ExportExcelView, ExportPdfView, RapportDetailView, ReportingView,
    TableauBordView,
)

urlpatterns = [
    path('statistiques/tableau-de-bord/', TableauBordView.as_view(), name='statistics_tableau_bord'),
    path('statistiques/reporting/', ReportingView.as_view(), name='statistics_reporting'),
    path('statistiques/reporting/rapport/<str:rapport_id>/', RapportDetailView.as_view(), name='statistics_rapport_detail'),
